...
export const FeaturesSection = () => {
  return (
    <section 
      id="features" 
      className="py-24 border-y border-[#E0DDD6] bg-cover bg-center bg-no-repeat relative"
    ...
    >
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Feature 1 */}
          <div className="bg-white/95 backdrop-blur-sm p-8 rounded-2xl border border-[#E8EDE0] shadow-sm hover:shadow-md transition-shadow font-sans">
