...
export const HowItWorks = () => {
  return (
    <section 
      id="how-it-works" 
      className="py-24 bg-cover bg-bottom bg-no-repeat relative"
    ...
    >
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center mb-16">
          ...
          <p className="text-[#3D5226] text-lg max-w-2xl mx-auto font-sans font-medium">Đơn giản hóa hành trình đầu tư của bạn với 3 bước dễ dàng.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8 font-sans">
          {/* Step 1 */}
          <div className="bg-[#2B3A1A]/85 backdrop-blur-sm border border-[#3D5226] rounded-2xl p-8 relative overflow-hidden group hover:border-[#7A9B58] transition-colors shadow-lg">
          ...
          {/* Step 2 */}
          <div className="bg-[#2B3A1A]/85 backdrop-blur-sm border border-[#3D5226] rounded-2xl p-8 relative overflow-hidden group hover:border-[#7A9B58] transition-colors mt-0 md:mt-8 shadow-lg">
          ...
          {/* Step 3 */}
          <div className="bg-[#2B3A1A]/85 backdrop-blur-sm border border-[#3D5226] rounded-2xl p-8 relative overflow-hidden group hover:border-[#7A9B58] transition-colors mt-0 md:mt-16 shadow-lg">
